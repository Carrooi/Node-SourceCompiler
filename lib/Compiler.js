...
(function() {
  var Cache, Compiler, FileStorage, Finder, Q, cleanCss, coffee, eco, exec, fs, less, path, sass, stylus, uglify,
  ...
  Compiler = (function() {
    ...
    Compiler.compileFile = function(_path, options) {
      ...
      options.path = _path;
      deferred = Q.defer();
      if (this.cache === null || __indexOf.call(this.cachableWithDeps, type) >= 0 && typeof options.dependents === 'undefined') {
        options.dependents = this._parseDependents([_path]);
