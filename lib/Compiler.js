...
(function() {
  var BaseCompiler, Cache, Compiler, FileStorage, Finder, Helpers, HttpGetException, InvalidArgumentException, Q, fs, http, https, path;
  ...
  Compiler = (function() {
    Compiler.prototype.CACHE_NAMESPACE = 'source_compiler';
    ...
    Compiler.prototype.compile = function(type, data, options) {
      ...
      deferred = Q.defer();
      compiler = this.getCompiler(type);
      compiler.parse(data, options).then(function(data) {
        var minifier;
        if (options.minify) {
